...
public enum ErrorStatus implements BaseErrorCode {
    ...
    PAGE_INVALID(HttpStatus.BAD_REQUEST, "COMMON4010", "페이지 번호는 0 이상이어야 합니다."),
    SIZE_INVALID(HttpStatus.BAD_REQUEST, "COMMON4011", "페이지 크기는 1 이상 100 이하이어야 합니다."),

    // 유저 관련 응답
    USER_NOT_FOUND(HttpStatus.NOT_FOUND, "USER4004", "존재하지 않는 유저입니다."),

    // 아티클 관련 응답
    ARTICLE_NOT_FOUND(HttpStatus.NOT_FOUND, "ARTICLE4004", "존재하지 않거나 삭제된 아티클입니다.");
